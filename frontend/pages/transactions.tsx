      ...
      <DashboardLayout>
        <div className="px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Monitor all your cross-chain transactions and treasury activities</p>
          </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="text-left py-3 px-4 font-semibold text-gray-700">Labels</th>
                  ...
                  <tbody>
                    {filteredTransactions.map((tx) => (
                      <tr key={tx.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4">
                          <span className="font-medium text-gray-900">{tx.quantity}</span>
                        </td>
                        <td className="py-3 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <Card>
              <CardContent className="pt-6">
                <div className="text-2xl font-bold text-gray-900">{sampleTransactions.length}</div>
                <div className="text-sm text-gray-600">Total Transactions</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                <div className="text-2xl font-bold text-green-600">40,050 USDC</div>
